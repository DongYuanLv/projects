...
{   
	...
	circle(backgound, center, radius+100, Scalar(255,0,0), thickness,8);
	circle(backgound, center, radius+50, Scalar(0, 255, 0), thickness, 8);
	circle(backgound, center, radius, Scalar(0, 0, 255), thickness, 8);
